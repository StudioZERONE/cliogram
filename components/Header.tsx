      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl border border-[var(--border)] bg-[var(--bg)] px-3 py-1.5 transition-colors hover:border-[#057a5d] dark:hover:border-emerald-500 cursor-pointer shadow-xs"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#057a5d] dark:bg-emerald-600 font-bold text-white text-sm">
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-2 shadow-xl animate-in zoom-in-95 z-50">
              ...
              <div className="py-1">
                ...
                >
                  <User className="h-4 w-4 text-[#057a5d] dark:text-emerald-400" />
                  <span>계정 정보 관리</span>
                </button>
